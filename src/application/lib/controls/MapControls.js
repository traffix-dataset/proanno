...
THREE.MapControls = function ( object, domElement ) {
    ...
    var pan = function () {
        ...
        return function pan( deltaX, deltaY ) {
            ...
            if ( scope.object.isPerspectiveCamera ) {
                ...
                console.warn( 'WARNING: MapControls.src encountered an unknown camera type - pan disabled.' );
    ...
    function dollyIn( dollyScale ) {
        ...
        if ( scope.object.isPerspectiveCamera ) {
            ...
            console.warn( 'WARNING: MapControls.src encountered an unknown camera type - dolly/zoom disabled.' );
