// THREEx.KeyboardState.src keep the current state of the keyboard.
...
// ```keyboard.destroy()```
//
// NOTE: this library may be nice as standaline. independant from three.src
 ...
 *   - microevent.src for events handling
